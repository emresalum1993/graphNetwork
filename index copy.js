        ...
        events: {
            click: (event) => {
                ...
                if (event.point.selected && event.point.state == "select") {
                    //not selected
                    event.point.linksFrom.forEach((point, i) => {


                        point.toNode.color = "#7cb5ec"
                        point.toNode.state = "select"
                        point.toNode.selected = true
                        point.toNode.category = ""

                    })
                    event.point.linksTo.forEach((point, i) => {
                        point.fromNode.options.selected = true

                        point.fromNode.color = "#7cb5ec"
                        point.fromNode.state = "select"
                        point.fromNode.selected = true
                        point.toNode.category = ""
                    ...
                    chart.series[0].points.forEach((point) => {
                            ...
                            point.fromNode.state = "select"
                            point.fromNode.selected = true
                            point.fromNode.category = ""
                            point.fromNode.className = point.fromNode.className.replace("selected", "")

                            point.toNode.color = "#7cb5ec"
                            point.toNode.state = "select"
                            point.toNode.selected = true
                            point.toNode.category = ""
                            point.toNode.className = point.toNode.className.replace("selected", "")
                        ...
                        //selected
                    event.point.linksFrom.forEach((point, i) => {
                        point.toNode.color = "red "
                        point.toNode.state = "select"
                        point.toNode.options.selected = true
                        point.toNode.selected = false
                        point.toNode.category = "selected"
                        point.toNode.className += " selected"
                    ...
                    event.point.linksTo.forEach((point, i) => {
                        point.fromNode.options.selected = true
                        point.fromNode.color = "red "
                        point.fromNode.state = "select"
                        point.fromNode.selected = true
                        point.fromNode.category = "selected"
                        point.fromNode.className += " selected"
                    })

                    console.log(event.point.linksFrom)
                    console.log(event.point.linksTo)
                    clicked.options.selected = true
                    clicked.color = "#7cb5ec"
                    clicked.state = ""
